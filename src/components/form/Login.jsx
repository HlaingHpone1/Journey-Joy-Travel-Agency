  ...
  return (
    <div>
      ...
      <div className="input py-4 pl-2 flex  items-center w-96 bg-white">
        ...
        <input type='text' className='focus:outline-0 text-lg bg-transparent text-black' placeholder='Email' value={email}
      ...
      <div className="input py-4 pl-2 flex items-center bg-white ">
        ...
        <input type='text' className='focus:outline-0 text-lg bg-transparent text-black' placeholder='Password' value={password} onChange={passwordHandler}/><br/>
      </div>
